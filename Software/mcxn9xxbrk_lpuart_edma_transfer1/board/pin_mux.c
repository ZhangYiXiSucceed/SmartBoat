...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port0_11_pinB13_config = {/* Internal pull-up/down resistor is disabled */
                                                          kPORT_PullDisable,
                                                          /* Low internal pull resistor value is selected. */
                                                          kPORT_LowPullResistor,
                                                          /* Fast slew rate is configured */
                                                          ...
                                                          /* Pin Control Register fields [15:0] are not locked */
                                                          kPORT_UnlockRegister};
	/* PORT0_10 (pin B12) is configured as CT0_MAT1 */
	PORT_SetPinConfig(PORT0, 11U, &port0_11_pinB13_config);
	...
	const port_pin_config_t port0_12_pinD11_config = {/* Internal pull-up/down resistor is disabled */
	                                                          ...
	                                                          /* Pin Control Register fields [15:0] are not locked */
	                                                          kPORT_UnlockRegister};
	/* PORT0_10 (pin B12) is configured as CT0_MAT2 */
	PORT_SetPinConfig(PORT0, 12U, &port0_12_pinD11_config);


    const port_pin_config_t port1_10_pinC13_config = {/* Internal pull-up/down resistor is disabled */
                                                          kPORT_PullDisable,
                                                          /* Low internal pull resistor value is selected. */
                                                          kPORT_LowPullResistor,
                                                          /* Fast slew rate is configured */
                                                          ...
                                                          /* Pin Control Register fields [15:0] are not locked */
                                                          kPORT_UnlockRegister};
	/* PORT3_10 (pin F12) is configured as CT1_MAT0 */
	PORT_SetPinConfig(PORT1, 10U, &port1_10_pinC13_config);
